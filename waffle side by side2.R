...
xdf_wide %>% 
  mutate(labels=paste(Surveillance_vals,suboutcomes,"with surveillance vs.",No_surveillance_vals,"without"),
         "No_surveillance_vals spacer"=round(squares_per_row+
           squares_per_row*2-squares_per_row*((No_surveillance_vals/squares_per_row)-
                                              floor(No_surveillance_vals/squares_per_row))),
         "Surveillance_vals spacer"=round(squares_per_row+
              squares_per_row*2-squares_per_row*((Surveillance_vals/squares_per_row)-
